...
class BitBoard {
   ...
   * @returns BitBoard
   */
  orNumber(shiftAmount: number, num: number = 1): BitBoard {
   ...
   * @returns BitBoard
   */
  xOrNumber(shiftAmount: number, num: number = 1): BitBoard {
    if (typeof shiftAmount === 'number') {
